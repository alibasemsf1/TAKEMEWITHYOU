		...
		let o = function () {
			...
			l = function (t, i, o) {
				...
				l.on("click", function (e) {
					if($(this).hasClass("checked_image")){
						//$(l).removeClass("checked_image");
						//$(".uploaded-image").removeClass("checked_image");
					}else{
						$(".uploaded-image").removeClass("checked_image");
						$(this).addClass("checked_image");
					}
				})
				if (o) {
